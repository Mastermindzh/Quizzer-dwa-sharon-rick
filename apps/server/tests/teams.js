...
Test('/teams/', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         * responses: 200
         */
        t.test('test getTeams get operation', function (t) {
            Mockgen().requests({
                path: '/teams/',
                operation: 'get'
            }, function (err, mock) {
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/teams/']['get']['responses']['200']['schema']);
         ...
         * responses: 200
         */
        t.test('test addTeam post operation', function (t) {
            Mockgen().requests({
                path: '/teams/',
                operation: 'post'
            }, function (err, mock) {
