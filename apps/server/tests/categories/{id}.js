...
/**
 * Test for /categories/{id}
 */
Test('/categories/{id}', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         * responses: 200
         */
        t.test('test getCategoryById get operation', function (t) {
            Mockgen().requests({
                path: '/categories/{id}',
                operation: 'get'
            }, function (err, mock) {
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/categories/{id}']['get']['responses']['200']['schema']);
