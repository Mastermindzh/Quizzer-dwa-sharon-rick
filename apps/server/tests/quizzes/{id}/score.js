...
/**
 * Test for /quizzes/{id}/score
 */
Test('/quizzes/{id}/score', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         * responses: 200
         */
        t.test('test getCurrentScoreByQuizId get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/quizzes/{id}/score']['get']['responses']['200']['schema']);
