...
/**
 * Test for /quizzes/{id}/currentQuestion
 */
Test('/quizzes/{id}/currentQuestion', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         * responses: 200
         */
        t.test('test getCurrentQuestionByQuizId get operation', function (t) {
            Mockgen().requests({
                path: '/quizzes/{id}/currentQuestion',
                operation: 'get'
            }, function (err, mock) {
                var request;
                t.error(err);
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/quizzes/{id}/currentQuestion']['get']['responses']['200']['schema']);
