...
/**
 * Test for /quizzes/{id}/{questionId}/{teamName}/answers
 */
Test('/quizzes/{id}/{questionId}/{teamName}/answers', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         * responses: 200
         */
        t.test('test addAnswer put operation', function (t) {
            Mockgen().requests({
                path: '/quizzes/{id}/{questionId}/{teamName}/answers',
                operation: 'put'
            }, function (err, mock) {
                var request;
                t.error(err);
