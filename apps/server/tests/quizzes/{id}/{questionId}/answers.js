...
/**
 * Test for /quizzes/{id}/{questionId}/answers
 */
Test('/quizzes/{id}/{questionId}/answers', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         * responses: 200
         */
        t.test('test getAnswerInQuizByQuestionId get operation', function (t) {
            Mockgen().requests({
                path: '/quizzes/{id}/{questionId}/answers',
                operation: 'get'
            }, function (err, mock) {
                var request;
                t.error(err);
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/quizzes/{id}/{questionId}/answers']['get']['responses']['200']['schema']);
