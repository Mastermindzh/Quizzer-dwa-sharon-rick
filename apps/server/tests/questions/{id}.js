...
/**
 * Test for /questions/{id}
 */
Test('/questions/{id}', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         * responses: 200
         */
        t.test('test getQuestionById get operation', function (t) {
            Mockgen().requests({
                path: '/questions/{id}',
                operation: 'get'
            }, function (err, mock) {
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/questions/{id}']['get']['responses']['200']['schema']);
