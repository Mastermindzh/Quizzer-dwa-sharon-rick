...
Test('/quizzes/', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         * responses: 200
         */
        t.test('test getQuizzes get operation', function (t) {
            Mockgen().requests({
                path: '/quizzes/',
                operation: 'get'
            }, function (err, mock) {
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/quizzes/']['get']['responses']['200']['schema']);
         ...
         * responses: 200
         */
        t.test('test addQuiz post operation', function (t) {
            Mockgen().requests({
                path: '/quizzes/',
                operation: 'post'
            }, function (err, mock) {
