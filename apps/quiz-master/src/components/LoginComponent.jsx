  ...
  render() {
    ...
    return (
      <div className="container">
        ...
        <TitleComponent title="Quizzer - Quizmaster Login" />
        <div className="text-center">
          <div className="col-lg-3" />
          <BoxComponent size="6">
            <h2 className="header-distance">Log in</h2>
            <p>Please enter the code of the quiz you want to manage</p>
            <div className="col-lg-12">
              <form onSubmit={this.handleSubmit}>
                <div className="form-group">
                  <input type="text" name="pubpass" className="form-control" id="code" placeholder="Quiz code" onChange={this.handleChange.bind(this, "code")} />
                </div>
                <div className="col-lg-12" style={{ paddingTop: '40px' }}>
                  <SubmitButton text="Log in!" enabled={code.length > 0} />
                </div>
              </form>
            </div>
